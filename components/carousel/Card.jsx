...
const Card = ({
  ...
  return (
    <div className="sm:w-[350px] w-[290px] bg-gray-800 border border-gray-700 rounded-lg shadow-lg hover:shadow-black/70 hover:shadow-xl hover:-translate-y-2 ease-in duration-200">
      <a href="#">
