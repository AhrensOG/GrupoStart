...
const Footer = () => {
  return (
    <div className='bg-[#0b52c3] flex flex-col-reverse sm:flex-row px-4 py-12 gap-4'>
      ...
      <div className='flex flex-col md:flex-row md:flex-wrap items-center sm:basis-1/3 md:basis-[45%] md:gap-2 justify-evenly'>
        <Link href={'/empresas'}>
          <span className='text-sm font-roboto text-white hover:text-[#ff4300]'>Empresas</span>
        </Link>
        <Link href={'/servicios/CommunityManager'}>
          <span className='text-sm font-roboto text-white hover:text-[#ff4300]'>Community Manager</span>
        </Link>
        <Link href={'/servicios/DesarrolloWeb'}>
          <span className='text-sm font-roboto text-white hover:text-[#ff4300]'>Desarrollo Web</span>
        </Link>
        <Link href={'/servicios/MarketingDigital'}>
          <span className='text-sm font-roboto text-white hover:text-[#ff4300]'>Marketing Digital</span>
        </Link>
      </div>
    </div>
  )
