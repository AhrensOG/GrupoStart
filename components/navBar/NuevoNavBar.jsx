...
const NavBarWithSearch = ({ home = true, servicesDropdown = true, isFixed = true }) => {
  ...
  return (
    <div className={`bg-[#0853fc] ${isFixed ? 'fixed' : ''} top-0 w-full z-10 h-[80px] drop-shadow-2xl`}>
      ...
      <div className="flex flex-row items-center h-full">
        ...
        {/* SEARCH BAR */}
        <div className="hidden sm:flex basis-[100%] items-center">
          <SearchBar2 />
        </div>

        {/* OPTIONS */}
        <div className="hidden sm:flex flex-row basis-[50%] justify-end items-center">
          <Link href={"/"}>
