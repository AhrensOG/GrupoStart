...
const Hero = ({ title = 'Mi Negocio', description = 'Soluciones creativas, resultados creativos' }) => {
  return (
      <div className="bg-[url('https://static1.s123-cdn-static-a.com/ready_uploads/media/26424/2000_5cdd2aeec5281.jpg')]  h-[300px] sm:h-[400px] md:h-[500px] bg-cover bg-no-repeat bg-center mt-[80px]">
